...
We defined “health-associated, typical” genera associated with adults, and provide these lists of signatures and prevalence in machine-readable formats for epidemiological analyses. 
...
1. Stool-associated genus of various exposures and reported to change in abundance BugSigDB
2. health-associated, typical genus associated with adults from curatedMetagenomicData
...
```{r} 
healthy30 = unlist(bugs30)
healthy50 = unlist(bugs50)
healthy70 = unlist(bugs70)
